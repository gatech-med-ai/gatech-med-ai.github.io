...
difficulty of acquiring medical data, medical AI tends to rely more heavily on ARCs than other applications.

Starting a team for an ARC is the following process:
...
- `ML Contests <https://mlcontests.com>`__
- `Codabench <https://www.codabench.org/competitions/public/?page=1>`__
- `Kaggle medical competitions <https://www.kaggle.com/search?q=medical+date%3A90+in%3Acompetitions>`__

Conferences
-----------

- `MICCAI <https://miccai.org/>`__

  - Tier 1: double-blind reviews
  - 25% acceptance rate

- `MIDL <https://www.midl.io/>`__

  - 50% acceptance rate
  - Newer conference with strong researcher reviews and growing visibility

- `IPMI <http://www.wikicfp.com/cfp/program?id=1643>`__

  - 24% acceptance rate
  - Official link not found

- `ISBI <https://biomedicalimaging.org/2026/full-program/>`__

  - 25% acceptance rate

- `EMBS <https://embc.embs.org/2026/>`__
- `MIUA <https://www.ucd.ie/medicine/miua2026/>`__